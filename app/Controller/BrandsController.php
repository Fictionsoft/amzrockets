...
class BrandsController extends AppController {
    ...
    public function video_Brands(){
        ...
        if($Brands){
            ...
            $this->Session->setFlash("Brand could not found",'default',array('class'=>'alert alert-danger'));
        }
    }
}