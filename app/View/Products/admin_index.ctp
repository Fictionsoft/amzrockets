...
?>
    ...
    <tr>
        ...
        <th><?php echo $paginator->sort('coupon_code') ?></th>
        <th><?php echo $paginator->sort('store_link') ?></th>
        <th>Photo</th>
        <th><?php echo $paginator->sort('status') ?></th>
        <th>Visit</th>
        <th><?php echo $paginator->sort('mail_required') ?></th>
    ...
    ?>
        <tr>
            ...
            <td><?php echo $this->Common->limit_text($product['Product']['name'], 15) ?></td>
            <td><?php echo $product['Product']['price'] ?></td>
            <td><?php echo $product['Product']['discount'] ?>%</td>
            <td><?php echo $product['Product']['coupon_code'] ?></td>
            <td><?php echo $product['Product']['store_link'] ?></td>
            ...
            <td><?php echo count($product['ProductVisitor']) ?></td>
            <td class="center"><?php echo $this->element('admin/toggle', array('status' => $product['Product']['mail_required'] )) ?>&nbsp;</td>
            <td>
                <?php
                    // edit link
